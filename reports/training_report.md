...
| 오류 유형 | 고객 수 | 최근 거래 활동 경과일 | 거래 횟수 | 상품 다양성 | 평균 거래 간격 | 최근 활동 비중 |
|---|---:|---:|---:|---:|---:|---:|
...
FN 고객은 최근 거래 활동 후 평균 47일, 거래 9.3회로 비교적 활동적인 모습이라 모델이 재구매 고객으로 판단했지만 실제로는 이탈했다. 이는 과거 활동성이 높다가 갑자기 중단한 고객을 행동 집계 Feature만으로 포착하기 어렵다는 뜻이다. 반대로 FP 고객은 최근 거래 활동 후 평균 173일, 평균 거래 간격 130일로 휴면 고객과 유사하지만 실제로 재구매했다. 장기 거래주기 고객이 FP에 포함될 가능성을 보여준다.
